...
public class CannyEdgeDetector extends ColorEdgeDetector {
    //static ImageProcessor img;
    //public static void main(String[] args)    {
    //    CannyEdgeDetector temp;
    //    temp = new CannyEdgeDetector(img);
    //    img = temp.getEdgeBinary();
    //}
	...
	public static class Parameters {	
		...
		public boolean isInValid () { // returns true if any 00
