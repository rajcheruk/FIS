...
public class Demo_RegionLabeling implements PlugInFilter {
	...
	public static boolean recolor = false;
	public static boolean listRegions = true;
        public static ImagePlus image;
        public static ImageProcessor imageIP;
        
        /*
        public static void main (String[] args)     {
            DemoRegionLabeling FISRegionLabel = new DemoRegionLabeling();
            FISRegionLabel.setup("DOES_RGB", image);
            FISRegionLabel.run(imageIP);
        }
	*/
    	...
    	//ByteProcessor bp;
	   	if (ip instanceof ByteProcessor) 
	   		bp = (ByteProcessor) ip.duplicate();
	   	else 
	   		bp = (ByteProcessor) ip.convertToByte(false);
	   	bp.autoThreshold();	// use the built-in auto-threshold method
	   	bp.invert();		// treat dark regions as FOREGROUND
     ...
     */
    public double mu_11 (RegionLabeling segmenter, BinaryRegion r) {
